"""Convert OCLC_LYRA_Cleaned.xlsx into lyra-policies.json.
...
Run: python3 scripts/build_lyra_policies.py
"""
...
SRC = ROOT / "OCLC_LYRA_Cleaned.xlsx"
DST = ROOT / "lyra-policies.json"
...
def main():
    ...
    out = {
        "_meta": {
            "description": (
                "LYRA (Lyrasis) library data used "
            ...
            "fields": {
                ...
                "group": "Always 'LYRA' for this dataset",
            },
        },
        "libraries": libraries,
    }
