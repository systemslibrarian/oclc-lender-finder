"""Convert OCLC_PLAN_Cleaned.xlsx into pla-policies.json.
...
Run: python3 scripts/build_pla_policies.py
"""
...
SRC = ROOT / "OCLC_PLAN_Cleaned.xlsx"
DST = ROOT / "pla-policies.json"
...
def main():
    ...
    out = {
        "_meta": {
            "description": (
                "PL@A (Panhandle Library Access Network) library data used "
            ...
            "fields": {
                ...
                "group": "Always 'PL@A' for this dataset",
            },
        },
        "libraries": libraries,
    }
